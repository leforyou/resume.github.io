...
<div class="container">
    ...
    <div class="transaction-info">
      <ul class="main-padding-lr bg-fff fz24">
        <li>
          <p class="left">商品名称：</p>
          <p class="right">橘红普洱</p>
        </li>
        <li>
          <p class="left">付款金额：</p>
          <p class="right main-color">￥318.00</p>
        </li>
        <li>
          <p class="left">订单编号：</p>
          <p class="right">546468762124</p>
        </li>
        <li>
          <p class="left">交易时间：</p>
          <p class="right">2018-05-09  14:25:59</p>
        </li>
      </ul>
    </div>
    ...
    <div class="reason">
      <ul class="main-padding-lr bg-fff fz24">
        ...
        <li class="border-btm">
          <p class="name">退款金额</p>
          <p class="desc">318.00</p>
        </li>
        <li class="border-btm">
          <p class="name">手机号码</p>
          <input class="desc" type="number" placeholder="便于商家联系您" maxlength="11" placeholder-class=".fc-999">
        </li>
        <li class="border-btm">
          <p class="name">备注信息</p>
          <textarea class="desc" type="text" placeholder="最多可填200字" maxlength="200" placeholder-class=".fc-999" auto-height="true"></textarea>
        </li>
      </ul>
    </div>

    <div class="submit main-padding-lr">
      <p class="btn fz30 fc-fff main-bg">确定提交</p>
    </div>
