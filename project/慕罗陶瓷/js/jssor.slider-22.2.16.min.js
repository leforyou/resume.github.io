...
window.addEventListener('DOMContentLoaded',function(){
	var jssorClass = document.getElementsByClassName('jssor');
	var arrJssorID = [],jssor_num = 'jssor_';
	for (var i = 0 ; i < jssorClass.length ; i ++) {
		arrJssorID[i] = function() {
		    ...
		    var jssor_1_slider = new $JssorSlider$((jssor_num+(i+1)), jssor_1_options);
	...
	for (var i = 0 ; i < arrJssorID.length ; i ++) {
		arrJssorID[i]();
	}
},false);
