...
<!--<div class="container" :class="{'overflow-y':isOverflow}">-->
  <div class="container">
    ...
    <productDetailSize ref="size"><!--商品规格--></productDetailSize>
...
export default {
  ...
  components: {
    swiperProductDetail,productDetailEvaluate,productDetailSuggest,productDetailSize,productDetailParameter
  },
